...
- Every completed attendance and waitlist outcome is retained permanently for audit and reporting.
- Selection totals and spendable attendance credits reset at the start of each calendar month; prior months cannot change the new month's roster priority.
...
2. Fewer confirmed appearances earlier in the same calendar month
3. More valid waitlists earlier in the same calendar month
