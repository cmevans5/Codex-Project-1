...
- Calendar-month fairness ranking with deterministic rotation and permanent audit history.
...
- Materialize current-month fairness totals from the complete ledger and verify them by replay.
- Enforce an automatic first-of-month reset for ranking totals and spendable credits.
